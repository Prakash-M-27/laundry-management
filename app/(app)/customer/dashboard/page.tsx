    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-2 mb-7 bg-muted/60 p-1 rounded-xl h-auto border border-border gap-0">
            <TabsTrigger
              value="orders"
              className="flex items-center gap-2 rounded-lg text-sm font-medium h-full data-[state=active]:bg-card data-[state=active]:shadow-sm data-[state=active]:text-primary data-[state=active]:!bg-card text-muted-foreground transition-all [&[data-state=active]_svg]:text-primary"
            >
          ...
          <TabsContent value="booking" className="mt-0">
            ...
            <div className="mt-8 relative">
              ...
              <div className="grid sm:grid-cols-3 gap-5">
                {STEPS.map((item, idx) => (
                  <div key={item.step} className="bg-card rounded-xl border border-border p-5 flex flex-col items-center text-center relative">
                    <div className="h-12 w-12 rounded-xl bg-primary/10 flex items-center justify-center text-primary mb-3 relative z-10">
                      {item.icon}
                    </div>
